...
streak = r'/Users/home/Downloads/processedLEOcal 2'
...
def streak_detection(streak, sigma=5.0, streakLength=20, TRM=True):
    fluxSat=[]
    xlocSat=[]
    ylocSat=[]
    imageSats=[]
    ...
    for dirpath, dirnames, filenames in os.walk(streak):
        ...
        for filename in filenames:
            ...
            if (filename.endswith(file_suffix)):
                ...
                mask = make_source_mask(fitsdata, nsigma=5, npixels=streakLength,
                                        dilate_size=11)
                ...
                if trm:
                    try:
                        bkg = Background2D(fitsdata, (30, 30), mask=mask,
