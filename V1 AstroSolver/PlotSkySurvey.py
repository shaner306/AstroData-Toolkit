...
fwhm = star_aux_table['FWHM_arcsec']
fwhm_sigma = star_aux_table['FWHM_arcsec_sigma']
...
# plt.savefig(r'G:\Suffield\2021 10 26 - ZWO with C14\Sky Survey\2021 10 26 - Pointing Run 1\Plate Solved\corrected_lights\Outputs_SkySurvey\FWHM_arcsec_plot')
plt.show()
plt.close()
